...
const EN = {
  ...
  archiveConfirm: "Archive all cards in Done?",
  cancel: "Cancel",
  restore: "Restore",
...
const STRINGS: Record<Locale, Record<MessageKey, string>> = {
  ...
  de: {
    ...
    archiveConfirm: "Alle Karten in Done archivieren?",
    cancel: "Abbrechen",
    restore: "Wiederherstellen",
    durationTooShort: "Mindestens 1 Minute.",
    showDataFolder: "Datenordner öffnen",
    showDataFolderError: "Der Datenordner konnte nicht geöffnet werden.",
  },
  es: {
    board: "Tablero",
    clock: "Reloj",
    ...
    archiveConfirm: "¿Archivar todas las tarjetas de Done?",
    cancel: "Cancelar",
    restore: "Restaurar",
    durationTooShort: "El mínimo es 1 minuto.",
    showDataFolder: "Mostrar carpeta de datos",
    showDataFolderError: "No se pudo abrir la carpeta de datos.",
  },
  fr: {
    board: "Tableau",
    clock: "Horloge",
    ...
    archiveConfirm: "Archiver toutes les cartes de Done ?",
    cancel: "Annuler",
    restore: "Restaurer",
    durationTooShort: "Minimum : 1 minute.",
    showDataFolder: "Afficher le dossier des données",
    showDataFolderError: "Impossible d’ouvrir le dossier des données.",
  },
  ru: {
    board: "Доска",
    clock: "Таймер",
    ...
    archiveConfirm: "Архивировать все карточки в Done?",
    cancel: "Отмена",
    restore: "Вернуть",
    durationTooShort: "Минимум 1 минута.",
    showDataFolder: "Показать папку данных",
    showDataFolderError: "Не удалось открыть папку данных.",
  },
  zh: {
    board: "看板",
    clock: "计时",
    ...
    reset: "复位",
    timerDone: "计时结束",
    archiveConfirm: "将 Done 中的卡片全部归档？",
    cancel: "取消",
    restore: "恢复",
    durationTooShort: "最短 1 分钟。",
    showDataFolder: "打开数据文件夹",
    showDataFolderError: "无法打开数据文件夹。",
  },
  fi: {
    board: "Taulu",
    clock: "Kello",
    ...
    persistenceCloseRegistrationError: "Suojausta suljettaessa ei voitu asentaa.",
    ...
    archiveConfirm: "Arkistoidaanko kaikki Done-sarakkeen kortit?",
    cancel: "Peruuta",
    restore: "Palauta",
    durationTooShort: "Vähintään 1 minuutti.",
    showDataFolder: "Avaa tietokansio",
    showDataFolderError: "Tietokansiota ei voitu avata.",
  },
};
