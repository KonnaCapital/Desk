const EN = {
  ...
  persistenceCloseTimeout: "The save is taking longer than expected. Desk is still open.",
  persistenceCloseError: "Desk could not save your latest changes. Desk is still open.",
  persistenceCloseSaved: "Your changes are saved. Retry to finish closing, or keep Desk open.",
  columnEmpty: "Empty",
  archiveEmpty: "Empty",
  restore: "Restore",
  start: "Start",
